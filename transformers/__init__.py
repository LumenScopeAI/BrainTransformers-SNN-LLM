...
try:
    ...
    _import_structure["models.braingpt"].append("BrainGPTTokenizerFast")
...
try:
    ...
    _import_structure["models.braingpt"].extend(
        [
            "BrainGPTForCausalLM",
...
if TYPE_CHECKING:
    ...
    from .models.braingpt import BRAINGPT_PRETRAINED_CONFIG_ARCHIVE_MAP, BrainGPTConfig, BrainGPTTokenizer
    ...
    try:
        ...
        from .models.braingpt import BrainGPTTokenizerFast
